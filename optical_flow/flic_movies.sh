...
# # im
# im_first_path="/home/ddk/cv.life/Nutstore/graduate.project/demo.images/pose0003.jpg"
# im_second_path="/home/ddk/cv.life/Nutstore/graduate.project/demo.images/pose0003_2.jpg"

# out_dire="/home/ddk/cv.life/Nutstore/graduate.project/demo.images/flow/"
# mkdir -p $out_dire

# # im
# im_first_path=" /home/ddk/dongdk/dataset/Kinect2/up.color/00000026.png"
# im_second_path="/home/ddk/dongdk/dataset/Kinect2/up.color/00000028.png"

# out_dire="/home/ddk/dongdk/dataset/Kinect2/optical.flow/up.color.demo/"
# mkdir -p $out_dire

# im dire
root_dire="/home/ddk/dongdk/dataset/Kinect2/"
im_first_path="${root_dire}up.crop.color/"
# im_second_path="${root_dire}positive.2/"

out_dire="${root_dire}optical.flow/up.crop.color/"
mkdir -p $out_dire
...
python flow_pipeline.py \
		...
		--cf_options "" \
		--df_options "-sintel " \
		--dm_options "-form_type 1 -GPU -v --downscale 1 --ngh_rad 192 " \
